...
public class BasicPositionEstimator implements PositionEstimator {
    ...
    float[] coeffs = {0.012190152f, 0.22678046f, 0.02301026f, 0.0066818492f, 0.003412304f, 0.0359393f, 0.028191911f, 0.010168288f, 4.9580354E-4f, 0.036333844f, 0.23074082f, 0.036072716f, 0.0011799715f, 0.001978657f, 7.993542E-4f, 0.02928545f, 0.020526076f, 0.05104921f, 0.031203484f, 0f};
    boolean array = false;
    ...
    private float maxTile() {
        return (float)Math.log((Integer)map.lastKey().getValue());
    }
    ...
    public float estimatePosition(Position p) {
        ...
        return coeffs[0]*numberOfDifferentTiles() + coeffs[1]*numberOfEmptyCells() + coeffs[2]*numberOfHorizontalPairs() +
                ...
                coeffs[18]*weightedMaxNumberOfPairsInOneDirection()+coeffs[19]*maxTile();
    }
}
