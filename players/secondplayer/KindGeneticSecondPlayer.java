 ...
 */
public class KindGeneticSecondPlayer extends AbstractSecondPlayer {
    private PositionEstimator positionEstimator;

    public KindGeneticSecondPlayer() {
    }

    public KindGeneticSecondPlayer(PositionEstimator positionEstimator) {
